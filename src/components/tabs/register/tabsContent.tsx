...
export const TabsContent = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex flex-col md:flex-row items-center justify-center [perspective:1000px] relative overflow-auto sm:overflow-visible no-visible-scrollbar  w-full mx-auto",
          containerClassName
        )}
      >
