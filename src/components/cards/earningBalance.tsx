...
export default function EarningBalance() {
  const { user, subscription, subscriptionPlan }: any = useUser();
    ...
    <>
      ...
      {subscriptionPlan && (
        <div className="flex flex-col items-center justify-center w-full">
          ...
          <div
            className="px-[1.57rem] py-[1.8rem] w-full border rounded-[1rem] gradient-1 max-h-[10.125rem] h-full relative shadow-card"
            style={{
              background: `linear-gradient(90deg, ${subscriptionPlan.main} 0%, ${subscriptionPlan.background} 100%)`,
            }}
          >
            <div className="flex flex-col items-start justify-start gap-1 w-full">
              ...
              <div className="flex flex-col items-start">
                <h2 className="text-[3rem] font-extrabold leading-[4rem] uppercase ">
